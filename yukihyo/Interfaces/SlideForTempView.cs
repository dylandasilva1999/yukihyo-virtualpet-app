...
namespace yukihyo.Interfaces
{
    public class SlideForTempView : AbsoluteLayout
    {
        public static readonly BindableProperty ThumbProperty =
            BindableProperty.Create(
                "Thumb", typeof(View), typeof(SlideForTempView),
        ...
        public static readonly BindableProperty TrackBarProperty =
            BindableProperty.Create(
                "TrackBar", typeof(View), typeof(SlideForTempView),
                defaultValue: default(View));
        ...
        public static readonly BindableProperty FillBarProperty =
            BindableProperty.Create(
                "FillBar", typeof(View), typeof(SlideForTempView),
                defaultValue: default(View));
